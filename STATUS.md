...
## Última atualização
- **Data**: 2026-07-18
- **Commit**: pendente (`test(backtesting): guard live-vs-point-in-time ROIC/Interest Coverage equivalence`)
- **Baseline de validação**: 952 testes verdes, 90,50% cobertura
