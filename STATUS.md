...
| `config/settings.json` | `run_all.py` e `universe/collector.py` | timeout 30s, 2 retries exponenciais, 2 req/s, campos críticos, snapshots brutos e segunda fonte SEC habilitada via segredo local |
