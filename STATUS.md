...
## Última atualização
- **Data**: 2026-07-18
- **Commit**: pendente (`fix(portfolio): pin exempt-sector defaults to deal_breakers.json with an equivalence test`)
- **Baseline de validação**: 950 testes verdes, 90,50% cobertura
