...
(CLI) — see ADR-031, which also adds a Massive Ticker Details fallback for
symbols with no SEC shares_outstanding. The full 2,429-symbol broad run
composed 2,254 (92.80%), no external vendor beyond Massive+SEC.
