...
this document)
**Validation baseline:** 846 tests passing / 88.83% production coverage
...
|---|---|---|
| Pipeline orchestration | `orchestration/pipeline.py`, `run_all.py` | Typed stages integrated; CLI preserved |
