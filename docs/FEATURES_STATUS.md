...
**Release:** v1.2.0
**Baseline:** PR-033 + point-in-time acquisition/derivation + deterministic PR-034 target/execution/validation cores
**Test baseline:** 563 passing / 88.52% production coverage
...
| Portfolio return/risk validation | Partial | No | No | No | Targets, next-open execution and metric cores; real execution/return data still open |
