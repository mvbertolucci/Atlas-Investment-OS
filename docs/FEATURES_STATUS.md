...
**Test baseline:** 913 passing / 90.50% production coverage

| Capability | Domain | Main pipeline | Excel | Morning Brief | Status |
|---|---:|---:|---:|---:|---|
| Market/fundamental collection | Yes | Yes | Yes | Yes | Operational |
| Provider resilience and raw evidence | Yes | Yes | No | No | Massive Basic confirms market cap and has resumable five-call/minute broad cache (10/2,429 measured so far); Massive + SEC derives EV; native Float precedes FMP fallback |
