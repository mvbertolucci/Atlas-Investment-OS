...
DASHBOARD_CONTRACT_VERSION = "1.7"
...
class DashboardView:
    ...
    decision_queue: dict[str, Any] | None = None
    portfolio_scenario: dict[str, Any] | None = None
    ...
    custody_history: dict[str, Any] | None = None
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "portfolio_scenario": self.portfolio_scenario,
            ...
            "custody_history": self.custody_history,
        }
